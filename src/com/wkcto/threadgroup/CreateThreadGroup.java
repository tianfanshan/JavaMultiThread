...
public class CreateThreadGroup {
    public static void main(String[] args) {
        ...
        //现在group1与group2都是mainGroup中的子线程组,调用线程组的getParent()方法返回父线程组
        ...
        //在main线程中创建了t1线程，乘main线程为父线程，t1线程为子线程，t1没有指定线程组则t1县城就归属到父线程main线程的线程组中
        Thread t1 = new Thread(r,"t1");
        System.out.println(t1);//Thread[t1,5,main],t1线程组时main线程组
        //创建线程时，可以指定线程所属线程组
